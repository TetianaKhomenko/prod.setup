Feature('Mark as completed/not completed @step-06 @Sc9363f87')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @Tb739b8ab', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @Td59026aa', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @T1ac5f969', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @Tbbc0a797', async ({ I, TodosPage }) => {

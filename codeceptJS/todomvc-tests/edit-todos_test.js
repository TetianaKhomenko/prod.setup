Feature('Edit/Delete Todos @step-06 @S4f41e35f')
...
Scenario('Edited todo is saved on blur @Tb654bfc3', async ({ I, TodosPage }) => {
...
Scenario('Delete todos @Td7c17212', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
